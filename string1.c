 ...
 * @dest: This is the destination of the str
 * @src: This is the source of the str
 *
 * Return: it returns the pointer to the destination
 */
 ...
 *
 * Return: It returns the pointer to the duplicate str
 */
 ...
 * @c: it is the char to be printed
 *
